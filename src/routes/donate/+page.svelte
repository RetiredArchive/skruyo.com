        ...
        <div class="flex w-full flex-col border-opacity-50 justify-center items-center">
            <div class="tooltip" data-tip="Cashapp">
                <a class="card bg-base-300 rounded-box grid h-40 place-items-center" href="https://cash.app/$Skruyo">
                    <img alt="Cashapp" class="size-40" src="/graphics/payments/cashapp.png"/>
                </a>
            </div>
            <div class="divider">OR</div>
            <div class="tooltip tooltip-bottom" data-tip="Paypal">
                <a class="card bg-base-300 rounded-box grid h-40 place-items-center" href="https://paypal.me/skruyo">
                    <img alt="Paypal" class="size-40" src="/graphics/payments/paypal.png"/>
                </a>
            </div>
        </div>
        <p class="m-4">Donating helps funds projects I want to do!</p>
    </div>
</div>